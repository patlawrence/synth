...
module.exports = class SynthClient extends Client {
	...
	loadCommands() {
		return glob(`${this.directory}src/commands/**/*.js`).then(commands => { // filters out non .js files
	...
	loadEvents() {
		return glob(`${this.directory}src/events/**/*.js`).then(events => { // filters out non .js files
